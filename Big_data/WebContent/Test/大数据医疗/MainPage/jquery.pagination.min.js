!function (t, a, e, i) {
    ...
    n.prototype = {
        init: function () {
            ...
            this.isRender = !0, this.homePage = '<a href="Line.jsp" class="ui-pagination-page-item" data-current="1">' + t.homePageText + "</a>", this.prevPage = '<a href="Line.jsp" class="ui-pagination-page-item" data-current="' + (a - 1) + '">' + t.prevPageText + "</a>", this.nextPage = '<a href="Line.jsp" class="ui-pagination-page-item" data-current="' + (a + 1) + '">' + t.nextPageText + "</a>", this.endPage = '<a href="Line.jsp" class="ui-pagination-page-item" data-current="' + e + '">' + t.endPageText + "</a>", this.checkPage(), this.isRender && n.html("<div class='ui-pagination-container'>" + this.homePage + this.prevPage + i + this.nextPage + this.endPage + "</div>")
        }, checkPage: function () {
            ...
            if (a <= n) for (g = 1; g <= a; g++) i += g === e ? '<a href="Line.jsp" class="ui-pagination-page-item active" data-current="' + g + '">' + g + "</a>" : '<a href="Line.jsp" class="ui-pagination-page-item" data-current="' + g + '">' + g + "</a>"; else {
                var s = n / 2;
                if (e <= s) for (g = 1; g <= n; g++) i += g === e ? '<a href="Line.jsp" class="ui-pagination-page-item active" data-current="' + g + '">' + g + "</a>" : '<a href="Line.jsp" class="ui-pagination-page-item" data-current="' + g + '">' + g + "</a>"; else {
                    var r = Math.floor(s), h = e + r, o = e - r, c = n % 2 == 0;
                    h > a && (c ? (o -= h - a - 1, h = a + 1) : (o -= h - a, h = a)), c || h++;
                    for (var g = o; g < h; g++) i += g === e ? '<a href="Line.jsp" class="ui-pagination-page-item active" data-current="' + g + '">' + g + "</a>" : '<a href="Line.jsp" class="ui-pagination-page-item" data-current="' + g + '">' + g + "</a>"
                }
            }
            return i
